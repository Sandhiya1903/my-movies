    ...
    <div className="fixed bottom-10 left-[30rem] transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded">
      <section className="flex justify-between items-center">
        ...
        <div className="flex justify-center items-center mb-[2rem]">
          ...
          >
            <MdOutlineLocalMovies className="mr-2 mt-[3rem] text-gray-100" size={26} />
          ...
          {!userInfo && (
            <ul className="flex">
              <li>
                ...
                >
                  <AiOutlineLogin className="mr-2 mt-[4px] text-gray-100" size={26} />
              ...
              <li>
                <Link
                  to="register"
                  className="flex items-center text-gray-100 mt-5 transition-transform transform hover:translate-x-2 ml-[1rem]"
                >
